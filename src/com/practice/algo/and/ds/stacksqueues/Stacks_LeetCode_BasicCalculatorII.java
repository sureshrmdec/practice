...
public class Stacks_LeetCode_BasicCalculatorII {
	...
	public static void main(String[] args) {
		...
		//  o.calculateLeet("3+2*2");
		  o.calculateLeet("2+10*2+4/2");
	...
	//I will go with ths one!!
	public int calculateLeet(String s) {
	    int len;
	    ...
	    for(int i=0;i<len;i++){
	        ...
	        if((!Character.isDigit(s.charAt(i)) &&' '!=s.charAt(i)) || i==len-1){ // i == len-1 (for last character)
	            if(sign=='-'){
	                stack.push(-num);
	            }
	            if(sign=='+'){
