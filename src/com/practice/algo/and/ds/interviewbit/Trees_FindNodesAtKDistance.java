...
public class Trees_FindNodesAtKDistance {
	...
	public static void main(String[] args) {
		...
		Trees_FindNodesAtKDistance o = new Trees_FindNodesAtKDistance();
		o.printKDistance(o1, 2, 2);
	}
