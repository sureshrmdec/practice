...
public class Arrays_LeetCode_IncreasingTripletSubsequence {

	public static void main(String[] args) {
		Arrays_LeetCode_IncreasingTripletSubsequence o = new Arrays_LeetCode_IncreasingTripletSubsequence();
		//int[] nums = {3,4,2,1,5};
		int[] nums = {3,4,2,1,5};
