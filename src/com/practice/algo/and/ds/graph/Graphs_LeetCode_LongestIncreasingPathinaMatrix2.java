...
public class Graphs_LeetCode_LongestIncreasingPathinaMatrix2 {

	public static void main(String[] args) {
		Graphs_LeetCode_LongestIncreasingPathinaMatrix2 o = new Graphs_LeetCode_LongestIncreasingPathinaMatrix2();
