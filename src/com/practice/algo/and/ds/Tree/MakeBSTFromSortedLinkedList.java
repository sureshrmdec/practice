...
public class MakeBSTFromSortedLinkedList {
	...
	public static void main(String[] args) {
		...
		bst.head = list.head;
		com.practice.algo.and.ds.Tree.Node root = bst.makeBSTFromSortedList(bst.head,7);
	...
	private com.practice.algo.and.ds.Tree.Node makeBSTFromSortedList(Node<Integer> head, int n) {
	    ...
	    com.practice.algo.and.ds.Tree.Node left = makeBSTFromSortedList(head, n/2);
	    ...
	    root.rightChild = makeBSTFromSortedList(MakeBSTFromSortedLinkedList.head, n-n/2-1);
