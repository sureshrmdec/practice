...
public class SegementTreeRecursive {
 ...
 */
public SegementTreeRecursive(int[] array) {
...
public static void main(String[] args) {
	...
	int n = sc.nextInt();
        ...
        st = new SegementTreeRecursive(array);
        int M = sc.nextInt();
		 
		  for(int i=0;i<M;i++){
			  int l = sc.nextInt();
			  int r = sc.nextInt();
			  System.out.println(st.RSQ(l,r));
		  }
		  st.update(1, 6, 5);
		  System.out.println(st.RSQ(1,6));
       /* else if (line[0].equals("init")) {
            ...
            System.out.printf("Sum from %d to %d = %d%n", arg1, arg2, st.RSQ(arg1, arg2));
        }
        else if (line[0].equals("rmq")) {
            System.out.printf("Min from %d to %d = %d%n", arg1, arg2, st.RMinQ(arg1, arg2));
        }
        else {
